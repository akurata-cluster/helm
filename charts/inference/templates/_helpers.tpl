...
{{- if .Chart.AppVersion }}
inference.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
inference.kubernetes.io/managed-by: {{ .Release.Service }}
{{- end }}
...
inference.kubernetes.io/name: {{ .name }}
inference.kubernetes.io/instance: {{ .ctx.Release.Name }}
role: leader
{{- end }}
